...
function T(t, e) {
  e.useNativeTimers
    ...
    : ((t.setTimeoutFn = _.setTimeout.bind(_)), (t.clearTimeoutFn = _.clearTimeout.bind(_)));
}
    ...
    polling: class extends C {
      ...
      uri() {
        const t = this.opts.secure ? "https" : "http",
          e = this.query || {};
        return (
          !1 !== this.opts.timestampRequests && (e[this.opts.timestampParam] = j()),
            ...
            "string" == typeof (e = n)
              ? (function (t) {
                  ...
                  for (let n = 0, i = t.length; n < i; n++)
                    (e = t.charCodeAt(n)),
                      e < 128 ? (s += 1) : e < 2048 ? (s += 2) : e < 55296 || e >= 57344 ? (s += 3) : (n++, (s += 4));
                  return s;
                })(e)
...
var yt = Object.freeze({
  ...
  Encoder: class {
    ...
    encodeAsString(t) {
      let e = "" + t.type;
      return (
        (t.type !== pt.BINARY_EVENT && t.type !== pt.BINARY_ACK) || (e += t.attachments + "-"),
        t.nsp && "/" !== t.nsp && (e += t.nsp + ","),
        null != t.id && (e += t.id),
